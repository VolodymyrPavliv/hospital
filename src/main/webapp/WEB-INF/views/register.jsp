    ...
    <form action="/register" method="post" class="form-signin">
        <div class="form-group">
            ...
            <c:if test="${emailExists}">
                <p class="text-danger"><fmt:message key="emailExists" /></p>
            </c:if>
            ...
            <c:if test="${passwordIncorrect}">
                <p class="text-danger"><fmt:message key="passwordIncorrect" /></p>
            </c:if>
            ...
            <c:if test="${passwordsDontMatch}">
                <p class="text-danger"><fmt:message key="passwordsDontMatch" /></p>
            </c:if>
            <label for="confirmPassword"><strong><fmt:message key="confirmPassword"/> </strong></label>
            <input type="password" id="confirmPassword" name="confirmPassword" class="form-control" placeholder="<fmt:message key='enterPassword'/>">

...
public class SQLConstants {
    ...
    public final static String INSERT_USER = "INSERT INTO users(name, surname, email, password)" +
            "VALUES (?, ?, ?,?)";
    ...
    public static final String ADD_ROLE_ID = "UPDATE users SET role_id = (?) WHERE id = ?";
}
